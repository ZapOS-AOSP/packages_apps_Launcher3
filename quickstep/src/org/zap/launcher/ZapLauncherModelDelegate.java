...
public class ZapLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "ZapLauncherModelDelegate";
    ...
    public ZapLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
