...
import org.zap.launcher.ZapLauncher;
import org.zap.launcher.ZapLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        ZapLauncher launcher = (ZapLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        ZapLauncherModelDelegate delegate = (ZapLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        ZapLauncher launcher = (ZapLauncher) ActivityContext.lookupContext(getContext());
